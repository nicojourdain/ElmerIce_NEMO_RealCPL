...
!##############################################################       
! lat,lon,rlat,rlon in rad
! x,y in m
! rlat,rlon, reference latitute and longitude
! USAGE:
!  transform xy to lat/lon in EPSG_3413:
!     call xy2LatLon(lat,lon,70.0_dp*pi/180._dp,-45._dp*pi/180._dp,x,y)
!  transformlat/lon to xy in Bamber Greenland Stereopolar Proj:
!     call LatLon2xy(lat,lon,71.0_dp*pi/180._dp,-39._dp*pi/180._dp,x,y)
!##############################################################       
!
