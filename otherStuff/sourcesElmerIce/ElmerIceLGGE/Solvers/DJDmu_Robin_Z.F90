...
!       -CostSolver_ArthernGud.f90: pour le calcul de la fonction cout;
!       -Optimize_m1qn3[Serial/Parallel]_Z.f90: pour l'optimisation
!

! *****************************************************************************
SUBROUTINE DJDMu_Robin_Z( Model,Solver,dt,TransientSimulation )
!------------------------------------------------------------------------------
!******************************************************************************
  USE DefUtils
  IMPLICIT NONE
...
!!!! Autres variables
  ...
  If (Firsttime) then
      WRITE(SolverName, '(A)') 'DJDMu_Robin_Z'
