!!! Apply the flotaison to update Zb and Zs from the ice thickness H
...
!------------------------------------------------------------------------------
  ...
  CHARACTER(LEN=MAX_NAME_LEN) :: SolverName='Flotaison'
...
!!
 ...
 Do t=1,Solver % Mesh % NumberOfBulkElements
    ...
    Do i=1,n 
       ...
       rhoi=Density(i)
       zb=zsea-H*rhoi/rhow
      ! if bedrock defined check flotaison criteria
